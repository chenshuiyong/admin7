package cc.mrbird.common.http.sms;


import cc.mrbird.common.http.Client;
import cc.mrbird.common.http.MethodType;
import cc.mrbird.common.http.Response;
import cc.mrbird.common.http.sms.model.SignatureInfo;
import cc.mrbird.common.http.sms.model.TemplateInfo;
import cc.mrbird.common.qiniu.QiniuException;
import cc.mrbird.common.util.qiniu.Auth;
import cc.mrbird.common.util.qiniu.Json;
import cc.mrbird.common.util.qiniu.StringMap;
import cc.mrbird.common.util.qiniu.UrlUtils;
